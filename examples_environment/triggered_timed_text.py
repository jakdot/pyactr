...
class Environment(env.Environment): #subclass Environment
    """
    Example of environment used for ACT-R model. This model changes display based on trigger or run_time. You can run this in u2_motormodel in the folder tutorials.
    """

    def __init__(self):
        self.text = "a b c d e f g".split()
        self.run_time = 0.27
